    ...
    if is_joined:
        ...
        if call.data=="guide":
           bot.edit_message_text(chat_id=call.message.chat.id,message_id=call.message.id,
                                ...
                                \n/avg:اگر این کامند را بزنی یعنی یک حدود قیمتی می خوای برای محصولی که الان تو ذهنت هست و خب من هم بعد از اینکه محصول  مدنظرت را گفتی اون رنج قیمتش را بهت میگم
